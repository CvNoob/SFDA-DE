...
__C.MODEL.PRETRAINED_FEATURE_EXTRACTOR = './visda_pretrained_r101.pth'
...
__C.TRAIN.MAX_LOOP = 1000
__C.TRAIN.ITER_PER_LOOP = 50
__C.TRAIN.START_DECAY = 50
__C.TRAIN.STOP_THRESHOLDS = (0.001, 0.001, 0.001)
__C.TRAIN.MIN_SN_PER_CLASS = 5
...
__C.TRAIN.VARIANCE_MULT = 1.0
__C.TRAIN.TRAIN_BN_MULT = False
...
__C.CLUSTERING.EPS = 0.001  # 0.005
